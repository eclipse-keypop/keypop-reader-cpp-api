...
public:
     ...
     * physical communication protocol name and the logical communication
     * protocol name defined by the application.
     *
     * <ul>
     *   <li>Activates the detection of cards using the provided reader
     * communication protocol. <li>Internally associates the two strings
